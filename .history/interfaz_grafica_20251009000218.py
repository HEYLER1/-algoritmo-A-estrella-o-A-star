...
from visualizador_restricciones import crear_boton_info_restricciones
    ...
    def crear_frame_costos(self):
        ...
        tk.Button(frame, text="❓ Info Heurísticas", 
            ...
            bg='#fff9c4', font=('Arial', 8)).grid(row=3, column=3, columnspan=2, padx=5, pady=5)
                ...
                # En el método crear_frame_costos, después del botón de heurísticas:
        tk.Button(frame, text="📚 Ver Restricciones Diagonales",
                        command=self.mostrar_restricciones_visuales,
                        bg='#FFC107', font=('Arial', 8, 'bold')).grid(row=4, column=3, columnspan=2, padx=5, pady=5)
